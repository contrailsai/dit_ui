                ...
                <>
                    ...
                    <div className=' fixed right-6 bottom-16 z-10 '>
                        ...
                        <div className=' flex flex-col items-end rounded-lg h-24 w-52 border-2 border-gray-300  bg-white px-3 py-2 '>
                            ...
                            <svg onClick={() => { set_res_data({}) }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className=" absolute cursor-pointer size-6">
